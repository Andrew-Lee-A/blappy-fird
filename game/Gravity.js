...
class Gravity extends Phaser.Scene {
  ...
  die() {
    ...
    if (this.currentHeart == 0) {
      ...
      console.log("current gravity score:" + data.getScore("gravity"));

      data.setScore("gravity", localStorage.getItem("currentScore"));
      console.log("now score:" + data.getScore("gravity"));
    } else {
